...
mn_cities <- st_read('ica/04_adv_maps/data/City_And_Township_Population_Centers/City_And_Township_Population_Centers.shp')
mn_water <- st_read('ica/04_adv_maps/data/Lakes_and_Rivers/Lakes_and_Rivers.shp')
```
